...
const addDiscountProduct = async (req, res, next) => {
    try {
        const data = await discountProductService.addDiscountProductService(
            req.body
        )
...
const getDiscountProductById = async (req, res, next) => {
    try {
        const data = await discountProductService.getDiscountProductByIdService(
            req.query.discountProductId
        )
        return res.status(StatusCodes.OK).json({
...
const getListDiscountProduct = async (req, res, next) => {
    try {
        const data = await discountProductService.getListDiscountProductService(
            req.body
        )
        return res.status(StatusCodes.OK).json({
...
const updateDiscountProduct = async (req, res, next) => {
    try {
        const data = await discountProductService.updateDiscountProductService(
            req.query.discountProductId,
            req.body
        )
        return res.status(StatusCodes.OK).json({
...
const deleteDiscountProduct = async (req, res, next) => {
    try {
        const data = await discountProductService.deleteDiscountProductService(
            req.query.discountProductId
        )
        return res.status(StatusCodes.OK).json({
            data,
...
const getProductsByDiscount = async (req, res, next) => {
    try {
        const data = await discountProductService.getProductsByDiscountService(
...
const getDiscountsByProduct = async (req, res, next) => {
    try {
        const data = await discountProductService.getDiscountsByProductService(
