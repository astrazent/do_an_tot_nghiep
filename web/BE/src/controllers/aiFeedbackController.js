...
const createOrUpdateFeedbackBySlug = async (req, res, next) => {
    try {
        const data =
            await aiFeedbackService.createOrUpdateFeedbackBySlugService(
                req.body
            )
        return res.status(StatusCodes.OK).json({
            message: 'Tạo mới feedback thành công',
...
const getByIdFeedback = async (req, res, next) => {
    try {
        const data = await aiFeedbackService.getByIdFeedbackService(
...
const getListFeedbackByProduct = async (req, res, next) => {
    try {
        const data = await aiFeedbackService.getListFeedbackByProductService(
            req.query.productId
        )
        return res.status(StatusCodes.OK).json({
...
const getListFeedbackByUser = async (req, res, next) => {
    try {
        const data = await aiFeedbackService.getListFeedbackByUserService(
            req.query.userId
        )
        return res.status(StatusCodes.OK).json({
...
const updateFeedback = async (req, res, next) => {
    try {
        const data = await aiFeedbackService.updateFeedbackService(
            req.query.feedbackId,
            req.body
        )
        return res.status(StatusCodes.OK).json({
...
const deleteFeedback = async (req, res, next) => {
    try {
        const data = await aiFeedbackService.deleteFeedbackService(
            req.query.feedbackId
        )
        return res.status(StatusCodes.OK).json({
