...
const UpdateStockModal = ({ productId, isOpen, onClose, onUpdateSuccess }) => {
    ...
    const handleSetMainImage = async imageId => {
        try {
            ...
            showAlert('Đã đặt làm ảnh chính thành công!', 'success')
        } catch (err) {
            console.error(err)
            showAlert('Lỗi khi đặt ảnh chính', 'error')
        }
    }
    ...
    const handleFileSelect = async e => {
        ...
        try {
            ...
            setImages(imagesRes.data || [])
            showAlert(`Đã thêm ${files.length} ảnh thành công!`, 'success')
        } catch (err) {
            console.error(err)
            showAlert('Upload ảnh thất bại. Vui lòng thử lại.', 'error')
        } finally {
                            ...
                            <div className="mb-6">
                                <label className="block">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-lg p-3"
                                        required
                                    />
                                </label>
                            </div>
                            ...
                            <div className="mb-6">
                                <label className="block">
                                    ...
                                    <textarea
                                        ...
                                        className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-base p-4 resize-none"
                                    />
                                </label>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-6 mb-8">
                                <label className="block">
                                    <span className="text-gray-700 font-medium flex items-center gap-1">
                                        <FiDollarSign className="text-emerald-500" /> Giá Bán (VND)
                                    </span>
                                    <input
                                        type="number"
                                        name="price"
                                ...
                                <label className="block">
                                    <span className="text-gray-700 font-medium flex items-center gap-1">
                                        <FiPackage className="text-emerald-500" /> Tồn Kho
                                    </span>
                                    <input
                                        type="number"
                                        name="stock_qty"
