...
const ProductList = () => {
    const products = [
        {
            name: 'Chả Vịt Vân Đình',
            desc: 'Đậm đà hương vị truyền thống',
            icon: '🦆',
            bg: chaVit,
            slug: 'cha-vit-thuy-hanh',
        },
        {
            name: 'Mọc Vịt Vân Đình',
            desc: 'Dai giòn, thơm ngon khó cưỡng',
            icon: '🍲',
            bg: mocVit,
            slug: 'moc-vit',
        },
        {
            name: 'Gà Ủ Muối / Xì Dầu',
            desc: 'Da giòn, thịt ngọt, đậm vị',
            icon: '🍗',
            bg: gaXuMuoi,
            slug: 'ga-u-xi-dau',
        },
        {
            ...
            desc: 'Đồ nhắm tuyệt hảo, tiện lợi',
            icon: '🥡',
            bg: chanVit,
        ...
        {
            name: 'Vịt Ủ Xì Dầu',
            desc: 'Hương vị đặc biệt, thơm lừng',
            icon: '🥘',
            bg: vitXiDau,
            slug: 'vit-u-xi-dau',
        },
        {
            name: 'Tai Heo Ủ Muối',
            desc: 'Giòn sần sật, vị ngon lạ miệng',
            icon: '🥓',
            bg: taiHeo,
            slug: 'tai-heo-u-muoi',
        },
        {
            name: 'Chả Sụn / Chả Chân Vịt',
            desc: 'Đặc sản độc đáo vùng miền',
            icon: '🍢',
            bg: chaSun,
            slug: 'cha-chan-vit',
        },
        {
            ...
            desc: 'Và nhiều sản phẩm sắp ra mắt',
            icon: '❄️',
            bg: dongLanh,
            slug: 'ngan-xong-khoi',
        },
            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        Chúng tôi tự hào là nhà phân phối{' '}
                        <span className="text-green-600 font-semibold">
                            ĐỘC QUYỀN
                        </span>{' '}
                        các dòng thực phẩm đặc sản vùng miền cao cấp, đảm bảo vệ
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {products.map((item, index) => (
                        ...
                        >
                            ...
                            <h3 className="relative z-10 text-xl font-bold text-gray-800 mb-2">
                                {item.name}
                            </h3>
