...
export const getPostsByPostTypeSlug = async ({
    slug = '',
    limit = 10,
    offset = 0,
    sort = 'newest',
    ...
    try {
        ...
        console.error(
            'Lỗi khi tải danh sách bài viết theo PostTypeSlug:',
            error
        )
        throw error
    }
...
export const getPostsByCategorySlug = async ({
    ...
    try {
        ...
        console.error(
            'Lỗi khi tải danh sách bài viết theo CategorySlug:',
            error
        )
        throw error
    }
...
export const getRelatedPostsBySlug = async ({
    slug = '',
    limit = 5,
    offset = 0,
} = {}) => {
