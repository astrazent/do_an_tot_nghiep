...
export const getListTransaction = async data => {
    try {
        const response = await axios.get(
            'http://localhost:2000/v1/transaction/list',
            {
...
export const updateTransaction = async (transactionId, data) => {
    try {
        const response = await axios.patch(
            `http://localhost:2000/v1/transaction/?transactionId=${transactionId}`,
            data
        )
        return response.data
    } catch (error) {
...
export const getDetailStatusOfTransaction = async () => {
    try {
        const response = await axios.get(
            `http://localhost:2000/v1/transaction/order_status_admin`
        )
        return response.data
    } catch (error) {
        console.error('Đã xảy ra lỗi khi lấy transaction:', error)
...
export const getOrderStats = async () => {
    try {
        const response = await axios.get(
            `http://localhost:2000/v1/transaction/order_stats`
        )
        return response.data
    } catch (error) {
...
export const getAverageProcessingTime = async () => {
    try {
        const response = await axios.get(
            `http://localhost:2000/v1/transaction/average_processing_time`
        )
        return response.data
    } catch (error) {
        console.error('Đã xảy ra lỗi khi lấy dữ liệu:', error)
...
export const getCancelRefundRate = async () => {
    try {
        const response = await axios.get(
            `http://localhost:2000/v1/transaction/cancel_refund_rate`
        )
        return response.data
    } catch (error) {
        console.error('Đã xảy ra lỗi khi lấy dữ liệu:', error)
...
export const getAverageProductRating = async () => {
    try {
        const response = await axios.get(
            `http://localhost:2000/v1/transaction/average_product_rating`
        )
        return response.data
    } catch (error) {
        console.error('Đã xảy ra lỗi khi lấy dữ liệu:', error)
