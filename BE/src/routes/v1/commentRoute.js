...
Router.route('/by_product_slug').post(verifyToken, commentController.createCommentByProductSlug)
...
Router.route('/by_product_slug').patch(verifyToken, commentController.updateCommentByUserAndProduct)
