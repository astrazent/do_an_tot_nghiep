...
const createOrUpdateReaction = async (req, res, next) => {
    try {
        const data = await commentReactionService.createOrUpdateReactionService(
            req.body
        )
...
const getReactionById = async (req, res, next) => {
    try {
        const data = await commentReactionService.getReactionByIdService(
...
const getReactionsByComment = async (req, res, next) => {
    try {
        const data = await commentReactionService.getReactionsByCommentService(
            req.query.commentId
        )
        return res.status(StatusCodes.OK).json({
...
const getReactionsByProduct = async (req, res, next) => {
    try {
        const data = await commentReactionService.getReactionsByProductService(
            req.query
        )
        return res.status(StatusCodes.OK).json({
            message: 'Lấy danh sách reaction theo comment thành công',
...
const getReactionsByUser = async (req, res, next) => {
    try {
        const data = await commentReactionService.getReactionsByUserService(
            req.query.userId
        )
        return res.status(StatusCodes.OK).json({
...
const countReactions = async (req, res, next) => {
    try {
        const data = await commentReactionService.countReactionsService(
            req.query.reactionId
        )
        return res.status(StatusCodes.OK).json({
